 ...
 */
package com.gabriel.ecommerce.checkout.event;
...
public class CheckoutCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6419303264472467709L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CheckoutCreatedEvent\",\"namespace\":\"com.gabriel.ecommerce.checkout.event\",\"fields\":[{\"name\":\"checkoutCode\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"}]},{\"name\":\"status\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"}]}]}");
   ...
   */
  public static com.gabriel.ecommerce.checkout.event.CheckoutCreatedEvent.Builder newBuilder() {
    return new com.gabriel.ecommerce.checkout.event.CheckoutCreatedEvent.Builder();
  }
   ...
   * @return A new CheckoutCreatedEvent RecordBuilder
   */
  public static com.gabriel.ecommerce.checkout.event.CheckoutCreatedEvent.Builder newBuilder(com.gabriel.ecommerce.checkout.event.CheckoutCreatedEvent.Builder other) {
    if (other == null) {
      return new com.gabriel.ecommerce.checkout.event.CheckoutCreatedEvent.Builder();
    } else {
      return new com.gabriel.ecommerce.checkout.event.CheckoutCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new CheckoutCreatedEvent RecordBuilder
   */
  public static com.gabriel.ecommerce.checkout.event.CheckoutCreatedEvent.Builder newBuilder(com.gabriel.ecommerce.checkout.event.CheckoutCreatedEvent other) {
    if (other == null) {
      return new com.gabriel.ecommerce.checkout.event.CheckoutCreatedEvent.Builder();
    } else {
      return new com.gabriel.ecommerce.checkout.event.CheckoutCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CheckoutCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.gabriel.ecommerce.checkout.event.CheckoutCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.gabriel.ecommerce.checkout.event.CheckoutCreatedEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.checkoutCode)) {
        this.checkoutCode = data().deepCopy(fields()[0].schema(), other.checkoutCode);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gabriel.ecommerce.checkout.event.CheckoutCreatedEvent.Builder setCheckoutCode(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gabriel.ecommerce.checkout.event.CheckoutCreatedEvent.Builder clearCheckoutCode() {
      checkoutCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gabriel.ecommerce.checkout.event.CheckoutCreatedEvent.Builder setStatus(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gabriel.ecommerce.checkout.event.CheckoutCreatedEvent.Builder clearStatus() {
      status = null;
